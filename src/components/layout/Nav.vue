    ...
    <nav class="-mx-3 space-y-60 ">
        <div v-if="iSLoggedin" class="space-y-3 ">
            ...
            <a href="/login" @click="userStore.logout()"
                class="flex items-center px-3 pt-10 pb-10 text-gray-600 transition-colors duration-300 transform rounded-lg mt-36 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
